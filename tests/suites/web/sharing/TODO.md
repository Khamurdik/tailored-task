...
| --- | --- | --- | --- |
| WEB-SHARING-001 | Opening the dialog creates no grant; the link is generated on demand | security | P1 |
| WEB-SHARING-007 | Closing the dialog without generating leaves no grant behind | security | P1 |
| WEB-SHARING-008 | Generating the link shows it exactly once with a clear warning | security | P1 |
| WEB-SHARING-009 | Reopening the dialog does not show the plaintext token again | security | P1 |
...
| WEB-SHARING-013 | The token is never written to the URL bar or browser history | security | P1 |

### Inviting a person by email

| ID | Behaviour | Kind | Pri |
| --- | --- | --- | --- |
| WEB-SHARING-014 | Inviting an existing user adds them to the grant list immediately | unit | P1 |
| WEB-SHARING-015 | Inviting an address with no account shows a pending state, not an error | unit | P1 |
...
| ID | Behaviour | Kind | Pri |
| --- | --- | --- | --- |
| WEB-SHARING-003 | Inherited grants show where they come from and offer no revoke button | unit | P1 |
| WEB-SHARING-004 | Direct grants offer revoke | unit | P1 |
| WEB-SHARING-021 | The list separates direct from inherited under clear headings | unit | P1 |
...
| WEB-SHARING-024 | A revoked grant disappears from the list without a manual refresh | unit | P1 |
| WEB-SHARING-025 | A failed revoke restores the row and explains why | unit | P1 |
...
| WEB-SHARING-028 | The indicator also appears on rows exposed only through inheritance | security | P1 |
| WEB-SHARING-029 | Hovering the indicator explains which ancestor grants the access | unit | P1 |
| WEB-SHARING-030 | The dialog is unavailable to a non-owner rather than failing on submit | security | P1 |

### Existing declarations

| ID | Behaviour | Kind | Pri |
| --- | --- | --- | --- |
| WEB-SHARING-002 | The plaintext token is shown once and the UI says so | security | P1 |
